...
<body>
  <div class="header-w3l">
    <h1> <span style="color:#4DC3FA">Create </span><span style="color:#FB667A">New User</span></h1>
    ...
    <div class="sub-main-w3"> 
      <form action="{{ route('users.store') }}" method="post">
        ...
        <div class="alert alert-danger">
          ...
          @endif
          {{ csrf_field() }}
          <input placeholder="username" name="email" class="user" type="text" required><br>
          <input placeholder="password" name="password" class="password"  type="text"><br>
